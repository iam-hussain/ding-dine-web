...
function Index() {
  return (
    <Box preset="stack-center" className="min-h-screen bg-gray-100">

<Box preset="grid-split" gap={0} className="min-h-screen md:gap-10">
<Box preset="stack-center" className="order-last p-6 md:order-none">
<img src={EatingTogether} alt="Eat Together" className="w-auto m-auto md:max-w-md" />
</Box>
<Box preset="stack-center" gap={10} className="container px-4 py-10 mx-auto grow">

<Box preset="stack-center" className="">
<Brand />
<Typography variant={'sub'} color={'light'} align="center" className="max-w-lg">
...
<Box preset="row-center" gap={4}>
            ...
            <Button variant={'secondary'}>Manager Login
              </Button>
            </Link>
